...
# Sainsburys Bank - Web - Lesson 2 - Parallel Testing

This repository shows a working example of multiple tests running in parallel on BrowserStack Automate.
...
```sh
git clone https://github.com/Manual-To-Automation-Sainsburys-Bank/Web-Lesson-2-Parallel-Testing.git
```

Move into the directory:

```sh
cd Web-Lesson-2-Parallel-Testing
```
